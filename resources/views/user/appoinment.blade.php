                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="contact_form">
                                <div id="message"></div>
                                <form id="" class="row" action="{{url(appointment)}}" method="POST">
                                    <fieldset class="row-fluid">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <textarea class="form-control" name="comment" id="comments" rows="6" placeholder="Give us more details.."></textarea>
                                        </div>
